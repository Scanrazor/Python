...
valorGauss=1
valorKernel=25
#imagen = cv2.imread('../Imagenes/monedas.jpg')#Con los .. Se regresa una carpeta atras
imagen = cv2.imread('C:/Users/roman/Desktop/python-webSite/ReconocimientoImagenes/Imagenes/monedassoles.jpg')
